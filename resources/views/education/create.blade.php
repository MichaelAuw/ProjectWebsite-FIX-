...
@section('content')
    <div class="container-fluid px-4">
        ...
        <ol class="bg-gray-2 breadcrumb mb-4">
            <li class="text-light breadcrumb-item active">Add Educations</li>
        </ol>
        @if($errors->any())
        ...
        <div class="bg-gray-2 text-light card mb-3">
            <div class="bg-gray-3 card-header text-white">Featured</div>
            <div class="card-body">
                        ...
                        <tr>
                            <td>
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="bg-gray-2 text-light form-control" placeholder="Enter Name" name="inputs[0][education]">
                                </div>
                            </td>
                            <td>
                    ...
                    '<tr>\
                        <td>\
                            <div class="mb-3 font-weight-bold">\
                                ...
                                <input type="text" class="bg-gray-2 text-light form-control" placeholder="Enter Name" name="inputs['+i+'][education]">\
                            </div>\
                        </td>\
                        <td>\
                            <div class="mb-3 font-weight-bold">\
                        ...
                        <td>\
                            ...
                            <a class="btn px-3 remove-table-row"><i class="text-light bi bi-trash"></i></a>\
                        </td>\
                    <tr>'
                );
            });
