...
@section('content')
    ...
    <div class="container-fluid px-4">
        <h1 class="text-light mt-4">Your Interests</h1>
        <ol class="bg-gray-2 breadcrumb mb-4">
            <li class="text-light breadcrumb-item active">In this page your can add and view the Interests you have</li>
        </ol>
        <div class="bg-gray-2 text-light card">
            <div class="card-body">
                <h5 class="card-title mb-3">List Interests</h5>

                <a href="{{ route('Interest.create') }}" class="btn btn-outline-light bi bi-plus-circle mb-2"> Add</a>
                    ...
                    <tbody>
                        @foreach ($data as $index => $item )
                            <tr>
                                ...
                                <td>
                                    <center>
                                        <a href="{{ route('Interest.edit',$item->id) }}" class="text-light btn bi bi-pen">Edit</a>
